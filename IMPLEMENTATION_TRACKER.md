...
Add one bounded SCM adapter unit case proving malformed source-of-record marker fails closed in normalization (`authoritative=true` + deny-like decision but missing/invalid SCM/Strata source marker returns no authoritative evidence).
