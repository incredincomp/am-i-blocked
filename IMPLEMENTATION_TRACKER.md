...
Add one bounded SCM adapter unit case proving deny-like authoritative candidate with invalid (non-SCM/Strata/Prisma) source marker fails closed in normalization and emits no authoritative evidence.
