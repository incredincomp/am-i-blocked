...
Add one bounded SCM adapter unit case proving deny-like authoritative candidate with malformed/non-integer port fails closed in normalization and emits no authoritative evidence.
