...
Add one bounded SCM adapter unit case proving deny-like authoritative candidate with malformed/non-string timestamp fails closed in normalization and emits no authoritative evidence.
