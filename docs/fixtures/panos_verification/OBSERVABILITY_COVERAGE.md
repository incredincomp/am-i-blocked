...
- Total versioned runs analyzed: 23
- Runs with `OBSERVABILITY_RECORD.json`: 2
- Runs with `VALIDATION_RESULT.json`: 3
- Proven token-validation scenarios: 1
- Observability-hit but token-not-proven scenarios: 1
- No-observability-hit scenarios: 20
- Loop-breaker blocked/rerun-risk scenarios: 18
...
- Family `10.1.99.3|10.1.20.21|30053|not-applicable|unknown|interzone-default|policy-deny|ssh_custom_command`: 2 no-hit run(s), 0 hit run(s), proven tokens=[].
...
- Observability records analyzed: 2
- Validation results analyzed: 3
- Capture manifests analyzed: 23
